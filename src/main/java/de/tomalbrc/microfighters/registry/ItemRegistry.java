...
public class ItemRegistry {
    ...
    public static final Object2ObjectLinkedOpenHashMap<Identifier, Item> CUSTOM_ITEMS;
    ...
    static public void register(DyeColor color) {
        Identifier identifier = Identifier.fromNamespaceAndPath(MicroFighters.MOD_ID, color.getName() + "_fighter");
    ...
    static public void registerDisintegrator() {
        Identifier identifier = Identifier.fromNamespaceAndPath(MicroFighters.MOD_ID, "disintegrator");
